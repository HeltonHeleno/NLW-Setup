      ...
      {habitsInfo?.possibleHabits.map(habit => {
        return (
          <Checkbox.Root
            ...
            defaultChecked={isDateInPast}
            className='flex items-center gap-3 group focus:outline-none desabled:cursor-not-allowed'
          >
            ...
            <span className='font-semibold texte-xl text-white leading-tight group-data-[state=checked]:line-through group-data-[state=checked]:text-zinc-400'>
              {habit.title}
            </span>
          </Checkbox.Root>
        )
