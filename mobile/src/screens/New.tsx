...
export function New(){
  ...
  async function hundleCreateNewHabit(){
    try {
  ...
  return(
    <View className="flex-1 bg-background px-8 pt-16">
      ...
      >
        ...
        <TextInput 
          className="h-12 pl-4 rounded-lg mt-3 bg-zinc-900 text-white border-zinc-800 border-2 focus:border-gray-600"   
